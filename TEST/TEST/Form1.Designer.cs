namespace TEST
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.менеджерыTableAdapter = new TEST.МенеджерыDataSetTableAdapters.МенеджерыTableAdapter();
            ...
            // comboBox1
            // 
            this.comboBox1.DataSource = this.менеджерыBindingSource;
            this.comboBox1.DisplayMember = "Name";
            this.comboBox1.FormattingEnabled = true;
            this.comboBox1.Location = new System.Drawing.Point(154, 62);
            ...
            this.менеджерыBindingSource.DataSource = this.менеджерыDataSet;
            // 
        ...
        private МенеджерыDataSetTableAdapters.МенеджерыTableAdapter менеджерыTableAdapter;
    }
}
